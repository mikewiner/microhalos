...
int main(int argc, char **argv)
{
  ...
  sprintf(path, "/cita/h/home-2/mwiner/AHF/TEST");
  sprintf(basename, "gadg_0256_1.53e-5_dm");
...
int do_what_you_want(void)
{
  ...
  FILE *f = fopen("particlepostions.txt", "w");
  if (f == NULL)
    {
	  ...
	  for(n = 0; n < header1.npart[k]; n++)
	    {
	      ...
	      //printf("This is your velocity %f \n", &P[pc_new].Vel[0]);
	      pc_new++;
	    }
	}
      SKIP;
